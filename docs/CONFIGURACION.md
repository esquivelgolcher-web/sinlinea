...
**Estado (2026-09-10):** la conexión real quedó verificada con la API de Threads (Probar destino 34480808061 desde la rama `multicanal-f2`: la credencial pertenece al perfil @luisegolcher, id 38207637362217152, que coincide con lo declarado; conexión apagada). La publicación en Threads sigue probada únicamente con clientes simulados y pruebas de extremo a extremo del panel; no se ha hecho ninguna publicación real. La primera será una pieza aprobada expresamente por el operador.
