...
**Estado (2026-09-10):** implementado y probado con clientes simulados (agrupación y duplicados, artículo inaccesible sin resumen inventado, hecho antiguo con su fecha, denuncias atribuidas, render del carrusel real con Chromium, borradores sin publicar, fuentes conservadas hasta el post). Primeros borradores reales generados con la corrida de GENERAR indicada en el ROADMAP. La publicación de carruseles en Instagram y Threads se desplegó el 2026-09-10, probada solo con clientes simulados (sin publicaciones reales): flujo completo con persistencia intermedia, huellas por diapositiva y recuperación sin duplicados. Pendiente de validar con la API real pieza a pieza y con aprobación expresa del operador. Facebook queda fuera de los carruseles: la publicación con varias fotos y la evidencia por `subattachments` no se confirmaron en la documentación oficial ni con la API real.
