...
export const FORMATOS = ["post", "carrusel", "reel", "frase", "glosa"];
export const NOMBRES_FORMATO = Object.freeze({ post: "Post", carrusel: "Carrusel", reel: "Reel", frase: "Frase", glosa: "Glosa" });
...
export const FORMATOS_PUBLICABLES = ["post", "carrusel", "frase", "glosa"];
